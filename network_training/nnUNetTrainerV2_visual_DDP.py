...
from nnunet.training.network_training.nnUNetTrainerV2_swin_visual import nnUNetTrainerV2_swin_visual
...
class nnUNetTrainerV2_visual_DDP(nnUNetTrainerV2_swin_visual):
